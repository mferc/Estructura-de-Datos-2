...
public class Pila {
    ...
    public void push(Nodo nuevo){ //Es mejor agregar un nodo al inicio
        addBegin(nuevo);
        
    }
    public int peek(){ //Lee el nodo de la cima de la pila, el inicio es nuestra cima
        return getAt(0);
        
    }
    public int pop() throws Exception{ //Lee y quita el nodo de la cima
        int iResu = getAt(0);
        deleteAt(0);
        return iResu;
    }
